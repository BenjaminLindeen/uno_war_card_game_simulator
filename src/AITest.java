public class AITest {
    public static void main(String[] args) {
        ...
        AI testAI = new AI();
        AI testBiggestCardAI = new BiggestCardAI();
        AI testSmallestCardAI = new SmallestCardAI();
        ...
        Card choiceB = testBiggestCardAI.getPlay(hand, pile);
        Card choiceS = testSmallestCardAI.getPlay(hand, pile);

        System.out.println("AI chose: "+choice);
        System.out.println("AI big chose: "+choiceB);
        System.out.println("AI small chose: "+choiceS);
    }
}
